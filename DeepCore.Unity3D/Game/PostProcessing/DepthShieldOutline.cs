...
namespace Specially
{
    ...
    public class DepthShieldOutline : MonoBehaviour
    {
        ...
        [Header("描边强度")] [Range(0.2f, 10.0f)] public float outlinePower = 2;

        //模糊半径  
        [Header("模糊半径")] [Range(0.2f, 10.0f)] public float BlurRadius = 1.0f;
        ...
        //迭代次数  
        [Header("采样次数")] [Range(0, 4)] public int iteration = 1;
        ...
        void Start()
        {
            ...
            outlineMaterial = new Material(Shader.Find("Depth/Outline"));
            SetObjectCamera();
        }
        ...
        private void SetObjectCamera()
        {
            ...
            {
                var go = new GameObject("ObjectCamera");
                go.transform.parent = transform;
                go.transform.localPosition = Vector3.zero;
                go.transform.localScale = Vector3.zero;
                go.transform.localEulerAngles = Vector3.zero;
                objectCamera = go.AddComponent<Camera>();
            ...
            depthTexture = RenderTexture.GetTemporary(Screen.width, Screen.height, 24, RenderTextureFormat.ARGBHalf,
        ...
        private void OnPreRender()
        {
            ...
            objectCamera.RenderWithShader(Shader.Find("/Depth/ShieldOutline_ObjectDepth"), "");
        }
