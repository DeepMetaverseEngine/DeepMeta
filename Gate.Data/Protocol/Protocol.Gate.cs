...
namespace Gate.Data.Protocol
{
    ...
    /// 链接Gate
    /// </summary>
    [MessageType(Constants.MSG_START + 0x01)]
    ...
    public class ClientEnterGateResponse : Response, IGateProtocol
    {
        ...
        [DependOnProperty(nameof(IsSuccess))] public string s2c_walletAddress;
        [DependOnProperty(nameof(IsSuccess))] public string s2c_connectAddress;
    ...
    [MessageType(Constants.MSG_START + 0x03)]
    public class ClientEnterGateInQueueNotify : Notify, IGateProtocol
    {
        ...
        /// 登陆Connector之必要信息
        /// </summary>       
        [DependOnProperty(nameof(IsEnetered))] public string s2c_connectAddress;
