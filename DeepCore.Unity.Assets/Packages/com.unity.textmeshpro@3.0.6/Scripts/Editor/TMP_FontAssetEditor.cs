...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_FontAssetEditor : Editor
    {
        ...
        private SerializedProperty m_ClearFontAssetDataOnEnable_prop;
        ...
        public void OnEnable()
        {
            ...
            m_ClearFontAssetDataOnEnable_prop = serializedObject.FindProperty("m_ClearFontAssetDataOnEnable");//×Ô¶¨Òå
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_ClearFontAssetDataOnEnable_prop);
