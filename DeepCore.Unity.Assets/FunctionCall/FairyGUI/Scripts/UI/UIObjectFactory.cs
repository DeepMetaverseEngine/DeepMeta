...
namespace FairyGUI
{
    ...
    public class UIObjectFactory
    {
        ...
        {
            SetPackageItemExtension(url, () => { return (GComponent)DeepActivator.CreateInstance(type); });
        }
        ...
        public static void SetExtension(string url, System.Type baseType, LuaFunction extendFunction)
        {
            ...
            {
                GComponent gcom = (GComponent)DeepActivator.CreateInstance(baseType);
        ...
        {
            loaderCreator = () => { return (GLoader)DeepActivator.CreateInstance(type); };
        }
        ...
        public static GObject NewObject(PackageItem pi, System.Type userClass = null)
        {
            ...
            if (pi.type == PackageItemType.Component)
            {
                if (userClass != null)
                {
                    ...
                    obj = (GComponent)DeepActivator.CreateInstance(userClass);
                }
