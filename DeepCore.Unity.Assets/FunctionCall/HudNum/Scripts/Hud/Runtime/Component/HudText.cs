...
namespace NFCore.Extension
{
    ...
    public class HudText : HudComponet
    {
...
//                 return;
//             }
//             int charCount = math.min(4 * quadLimit, chars.Length);
//             int snippetCount = (charCount - 1) / quadLimit + 1;
//             ResizeDataSnippet(snippetCount);
//             bool isUsingAlternativeTypeface;
//             float padding = ShaderUtilities.GetPadding(material, false, false);
//             float fontsize = m_FontSize / 10f;
...
//                 if (character != null)
//                 {
//                     if (curcharCount >= quadLimit && curcharCount % quadLimit == 0)
//                     {
...
//                     snippet.SetSpriteQuad(quadIndex, bottom_left, (top_right - bottom_left));
//                     float advance = (character.glyph.metrics.horizontalAdvance + m_Spacing) * currentElementScale + m_Spacing;
//                     curAdvance += advance;
//                     quadIndex++;
//                     curcharCount++;
//                 }
