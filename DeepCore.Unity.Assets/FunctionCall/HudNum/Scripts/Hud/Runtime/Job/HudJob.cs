...
public unsafe struct FillGPUInstanceFloat4Job : IJob
{
    ...
    [NativeDisableContainerSafetyRestriction]
    [ReadOnly]
    public NativeParallelMultiHashMap<int, RenderDataState<float4>> renderdataHashMap;
...
public unsafe struct FillGPUInstanceFloat4x4Job : IJob
{
    ...
    [NativeDisableContainerSafetyRestriction]
    [ReadOnly]
    public NativeParallelMultiHashMap<int, RenderDataState<float4x4>> renderdataHashMap;
