...
namespace CatJson
{
    ...
    public class ReflectionFormatter : IJsonFormatter
    {
        ...
        public object ParseJson(JsonParser parser, Type type, Type realType)
        {
            ...
            ParserHelper.ParseJsonObjectProcedure(parser,obj, realType, default, (parserAtg,userdata1, userdata2, userdata3, key) =>
            {
