...
namespace CatJson
{
    ...
    public class JsonParser
    {
        ...
        {
            formatterDict = new Dictionary<Type, IJsonFormatter>();

            formatterDict.Add(typeof(bool), new BooleanFormatter());
            formatterDict.Add(typeof(byte), new ByteFormatter());
            formatterDict.Add(typeof(sbyte), new SByteFormatter());
            formatterDict.Add(typeof(short), new Int16Formatter());
            formatterDict.Add(typeof(ushort), new UInt16Formatter());
            formatterDict.Add(typeof(int), new Int32Formatter());
            formatterDict.Add(typeof(uint), new UInt32Formatter());
            formatterDict.Add(typeof(long), new Int64Formatter());
            formatterDict.Add(typeof(ulong), new UInt64Formatter());
            formatterDict.Add(typeof(float), new SingleFormatter());
            formatterDict.Add(typeof(double), new DoubleFormatter());
            formatterDict.Add(typeof(decimal), new DecimalFormatter());
            formatterDict.Add(typeof(char), new CharFormatter());
            formatterDict.Add(typeof(string), new StringFormatter());
            formatterDict.Add(typeof(List<>), new ListFormatter());
            formatterDict.Add(typeof(Dictionary<,>), new DictionaryFormatter());
            formatterDict.Add(typeof(JsonObject), new JsonObjectFormatter());
            formatterDict.Add(typeof(JsonValue), new JsonValueFormatter());
        }

        private static Dictionary<Type, IJsonFormatter> formatterDict;
