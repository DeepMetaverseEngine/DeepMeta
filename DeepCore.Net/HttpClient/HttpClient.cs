...
{ 
    ...
    {
        public HttpClient(IExternalizableFactory codec, string name = null, int request_timer_tick_ms = 5000) : base(codec, name, request_timer_tick_ms)
        {
        }
        protected override IClientAdapter CreateAdapter(string addr) { return new HttpClientAdapter(this); }
    }

    public class HttpClientAdapter : Disposable, IClientAdapter
    {
        ...
        public HttpClientAdapter(INetClient client)
        {
            this.client = client;
