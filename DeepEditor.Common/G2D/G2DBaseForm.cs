...
{
    public class G2DBaseForm : MaterialForm, IG2DBaseComponent
    {
        ...
        static G2DBaseForm()
        {
            GlobalSkinManager.EnforceBackcolorOnAllComponents = true;
        }
        public G2DBaseForm()
        {
        ...
        protected override CreateParams CreateParams
        {
            get
            {
                ...
                cp.ClassStyle |= SystemShadow.CS_DropSHADOW;
                return cp;
            }
        }
        ...
        public class SystemShadow
        {
            ...
            public SystemShadow(Form owner)
            {
                // 在构造中调用此函数
                SetClassLong(owner.Handle, GCL_STYLE, GetClassLong(owner.Handle, GCL_STYLE) | CS_DropSHADOW);
        ...
        public class ShadowForm : Form
        {
            ...
            public ShadowForm(Form master)
            {
                base.Owner = master; //设置主子窗口  
                ...
                }
                {
                    ...
                    //                     SetLayeredWindowAttributes(this.Handle, 0, 220, LWA_ALPHA);
                ...
                Owner.Shown += (sender, e) =>
                {
                    OwnerRefreshShadow(true, true);
                };

                void OwnerRefreshShadow(bool redraw, bool reLoaction)
                {
                    if ((Owner != null) && (this != null))
                    {
                        try
                        {
                            this.Visible = (Owner.WindowState == FormWindowState.Normal) && (Owner.Visible);
                        }
                        catch { }

                        if (this.Visible)
                        {
                            this.RefreshShadow(redraw, reLoaction);
                        }
                    }
                }
            }
            ...
            public void Shadow_LocationChanged(Object sender, EventArgs e)
            {
            ...
            public void SetBitmap(Bitmap bitmap)
            {
                ...
                //                     this.TransparencyKey = bitmap.GetPixel(Width / 2, Height / 2);
                //                 }
                //                 catch { }
