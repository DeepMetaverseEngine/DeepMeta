...
namespace ST.Library.UI.NodeEditor
{
    ...
    public delegate bool STNodeOptionBeforeConnecting(STNodeOption src, STNodeOption dst);
    public delegate ConnectionStatus STNodeTestConnect(STNodeOption op);
    ...
    public delegate void STNodeEditorNodesMovedEventHandler(object sender, STNodeEditorMoveNodeEventArgs e);

    public class STNodeEditorMoveNodeEventArgs : EventArgs
    {
        public STNodeEditorMoveNodeEventArgs( )
        {
        }
    }
