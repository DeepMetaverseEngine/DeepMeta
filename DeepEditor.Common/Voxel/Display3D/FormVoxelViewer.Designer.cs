...
namespace DeepEditor.Common.Voxel.Display3D
{
    partial class FormVoxelViewer
    {
        ...
        {
            this.voxelViewer1 = new DeepEditor.Common.Voxel.Display3D.PanelVoxelViewer();
            this.SuspendLayout();
            // 
            // voxelViewer1
            // 
            this.voxelViewer1.AutoScroll = true;
            ...
            this.Name = "FormVoxelViewer";
            this.Text = "FormVoxViewer";
        ...
        private DeepEditor.Common.Voxel.Display3D.PanelVoxelViewer voxelViewer1;
    }
}