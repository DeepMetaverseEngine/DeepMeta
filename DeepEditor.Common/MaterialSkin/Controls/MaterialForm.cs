namespace MaterialSkin.Controls
{
    ...
    {
        //private readonly static TypeAllocRecorder Alloc = new TypeAllocRecorder(typeof(G2DBaseForm));
        ...
        public MaterialDrawer Drawer { get => drawerControl; }
        ...
        private const int STATUS_BAR_BUTTON_WIDTH = 28;
        private const int STATUS_BAR_HEIGHT_DEFAULT = 28;
        ...
        private int STATUS_BAR_HEIGHT = 32;
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposed == false)
            {
                ...
                SkinManager.ColorSchemeChanged -= SkinManager_ThemeChanged;
                drawerOverlay.Dispose();
                drawerForm.Dispose();
            }
        ...
        private void RecalculateFormBoundaries()
        {
            ...
            Padding = new Padding(_drawerShowIconsWhenHidden ? drawerControl.MinWidth : PADDING_MINIMUM, STATUS_BAR_HEIGHT + ACTION_BAR_HEIGHT + 2, Padding.Right, Padding.Bottom);
            originalPadding = Padding;
            ...
            if (ControlBox == true /*&& _formStyle != FormStyles.ActionBar_None && _formStyle != FormStyles.StatusAndActionBar_None*/)
            {
                switch (_formStyle)
                {
                    ...
                    case FormStyles.StatusAndActionBar_None:
                        ...
                        {
                            Rectangle textLocation = new Rectangle(STATUS_BAR_HEIGHT, 0, ClientSize.Width, STATUS_BAR_HEIGHT);
                            NativeText.DrawTransparentText(
                                Text, this.Font,
                                SkinManager.ColorScheme.FORM_TITLE_TEXT_COLOR,
