namespace MaterialSkin.Controls
{
    ...
    public class MaterialButton : Button, IMaterialControl
    {
        ...
        public MaterialButton()
        {
            ...
            SkinManager.ThemeChanged += SkinManager_ColorSchemeChanged;
            _hoverAnimationManager.OnAnimationProgress += _hoverAnimationManager_OnAnimationProgress;
            _focusAnimationManager.OnAnimationProgress += _hoverAnimationManager_OnAnimationProgress;
            _animationManager.OnAnimationProgress += _hoverAnimationManager_OnAnimationProgress;
        ...
        private void _hoverAnimationManager_OnAnimationProgress(object sender)
        {
            Invalidate();
        }
