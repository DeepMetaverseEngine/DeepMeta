namespace MaterialSkin.Controls
{
    ...
    public class MaterialDrawer : Control, IMaterialControl
    {
        ...
        public event OnPaintIconRectHandler OnPaintIconRect;

        public delegate void OnPaintIconRectHandler(PaintEventArgs e, TabPage tabPage, in Rectangle iconRect);
        ...
        private void preProcessIcons()
        {
            ...
            foreach (TabPage tabPage in _baseTabControl.TabPages)
            {
                ...
                {
                    gGray.SmoothingMode = SmoothingMode.AntiAlias;
                ...
                {
                    gColor.SmoothingMode = SmoothingMode.AntiAlias;
        ...
        private new void Paint(PaintEventArgs e)
        {
            ...
            foreach (TabPage tabPage in _baseTabControl.TabPages)
            {
                ...
                if (_baseTabControl.ImageList != null && !String.IsNullOrEmpty(tabPage.ImageKey))
                {
                    ...
                    OnPaintIconRect?.Invoke(e, tabPage, in iconRect);
                }
            }
