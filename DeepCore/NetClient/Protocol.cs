...
namespace DeepCore.NetClient
{
    ...
    /// Body:
    /// </summary>
    public abstract class IProtocol : Disposable
    {
        ...
        protected override void Disposing()
        {
            ...
            this.PkgMask = default;
            this.PkgLength = default;
            this.MsgType = default;
            this.MsgSendID = default;
            this.MsgRoute = default;
        }
        public override string ToString()
        {
            return $"PkgType={PkgType} PkgLength={PkgLength} MsgRoute=0x{MsgRoute.ToString("X8")} Body={BodyType}";
        }
        //--------------------------------------------------------------------------------------------------------------------
        #region Head
