...
namespace DeepCore.Voxel.StreamingVoxel.Data
{
    public class Codec : MessageFactoryGenerator
    {
        ...
        public Codec() : base("")
        {
            RegistExternalizable<StreamingChunk>();
            RegistExternalizable<StreamingCube>();
            RegistExternalizable<StreamingCubeTemplate>();
            RegistExternalizable<StreamingTouchLayer>();
            RegistExternalizable<StreamingMesh>();
        }
    }
    ...
    public class StreamingChunk : IExternalizable
    {
        ...
        public StreamingTouchLayer[,][] TouchGrids;
        ...
        public void ReadExternal(IInputStream input)
        {
            ...
            input.TryGetObj<StreamingTouchLayer[,][]>( (input) =>
            {
                var grid = new StreamingTouchLayer[ChunkSize.X, ChunkSize.Y][];
                grid.InitArray2D(this,(st,x, y) => input.GetExtArrayNoHead<StreamingTouchLayer>());
                return grid;
            }, out TouchGrids);
        ...
        public void WriteExternal(IOutputStream output)
        {
            ...
            {
                grid.ForEachArray2D(this, (st,layers, x, y) =>
                {
        ...
        public void InitTouchGrids()
        {
            if (Cubes != null && Cubes.Length > 0)
            {
                ...
                grid.ForEachArray2D(this, (st, cell, x, y) =>
                {
                    if (matrix[x, y] != null)
                    {
