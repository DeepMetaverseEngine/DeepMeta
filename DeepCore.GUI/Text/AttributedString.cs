...
namespace DeepCore.GUI.Display.Text
{
    ...
    /// 文字字符上的属性
    /// </summary>
    public class TextAttribute : ISerializable, ICloneable
    {
        /// <summary>
        ///  字符颜色 0 表示无特性 (RGBA)
        /// </summary>
        ...
        /// 字体
        /// </summary>
        public TextFontStyle fontStyle = TextFontStyle.STYLE_PLAIN;
        public bool underline
        {
            get
            {
                switch (fontStyle)
                {
                    case TextFontStyle.STYLE_BOLD_ITALIC_UNDERLINED:
                    case TextFontStyle.STYLE_ITALIC_UNDERLINED:
                    case TextFontStyle.STYLE_BOLD_UNDERLINED:
                    case TextFontStyle.STYLE_UNDERLINED:
                        return true;
                }
                return false;
            }
            set
            {
                if (!value)
                {
                    ...
                    {
                        case TextFontStyle.STYLE_BOLD_ITALIC_UNDERLINED:
                            fontStyle = TextFontStyle.STYLE_BOLD_ITALIC;
                            break;
                        case TextFontStyle.STYLE_ITALIC_UNDERLINED:
                            fontStyle = TextFontStyle.STYLE_ITALIC;
                            break;
                        case TextFontStyle.STYLE_BOLD_UNDERLINED:
                            fontStyle = TextFontStyle.STYLE_BOLD;
                            break;
                        case TextFontStyle.STYLE_UNDERLINED:
                            fontStyle = TextFontStyle.STYLE_PLAIN;
                            break;
                    }
                }
                else
                {
                    switch (fontStyle)
                    {
                        case TextFontStyle.STYLE_BOLD_ITALIC:
                            fontStyle = TextFontStyle.STYLE_BOLD_ITALIC_UNDERLINED;
                            break;
                        case TextFontStyle.STYLE_ITALIC:
                            fontStyle = TextFontStyle.STYLE_ITALIC_UNDERLINED;
                            break;
                        case TextFontStyle.STYLE_BOLD:
                            fontStyle = TextFontStyle.STYLE_BOLD_UNDERLINED;
                            break;
                        case TextFontStyle.STYLE_PLAIN:
                            fontStyle = TextFontStyle.STYLE_UNDERLINED;
                            break;
                    }
                }
            }
        ...
        /// 描边
        /// </summary>
        public TextBorderStyle borderCount = TextBorderStyle.Null;
        /// <summary>
        /// 描边颜色 (RGBA)
        /// </summary>
        ...
        public TextAttribute(
            ...
            float fSize = 0,
            object fName = null,
            TextFontStyle fStyle = TextFontStyle.STYLE_PLAIN,
            RichTextAlignment ta = RichTextAlignment.taNA,
            TextBorderStyle bCount = TextBorderStyle.Null,
            uint bColor = 0,
            string rImage = null,
            string rSprite = null,
            string pLink = null,
        ...
        protected virtual void DecodeAttribute(XmlElement node, XmlAttribute x_attr, TextAttribute attr)
        {
            switch (x_attr.Name)
            {
                ...
                case MF_TEXT_XML_KEY_SIZE:
                    {
                        attr.fontSize = int.Parse(node.GetAttribute(MF_TEXT_XML_KEY_SIZE));
                    }
                    break;
                ...
                case MF_TEXT_XML_KEY_B_COUNT:
                    {
                        attr.borderCount = (Data.TextBorderStyle)int.Parse(node.GetAttribute(MF_TEXT_XML_KEY_B_COUNT));
                    }
                    break;
