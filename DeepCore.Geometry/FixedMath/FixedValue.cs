...
namespace DeepCore.FixedMath
{
    public struct ffloat
    {
        ...
        public ffloat(ffloat other) { value = other.value; }
        ...
        public static ffloat operator +(ffloat x, ffloat y)
        {
            return new ffloat() { value = x.value + y.value };
        }
        public static ffloat operator -(ffloat x, ffloat y)
        {
            return new ffloat() { value = x.value - y.value };
