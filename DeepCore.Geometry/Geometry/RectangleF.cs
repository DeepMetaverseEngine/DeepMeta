...
#pragma warning restore CS0660 // 类型定义运算符 == 或运算符 !=，但不重写 Object.Equals(object o)
    {
        ...
        public float W { get => this.Width; set { this.Width = value; } }
        public float H { get => this.Height; set { this.Height = value; } }
        ...
        public static implicit operator RectangleF(in Geometry.Rectangle value)
        {
        ...
        /// <summary>
        /// Gets whether or not a specified <see cref="RectangleF"/> intersects with this <see cref="RectangleF"/>.
        /// </summary>
        /// <param name="value">Other <see cref="RectangleF"/>.</param>
        /// <returns><c>true</c> if other <see cref="RectangleF"/> intersects with this <see cref="RectangleF"/>; <c>false</c> otherwise.</returns>
        ...
        /// </summary>
        /// <param name="value">Other <see cref="RectangleF"/>.</param>
        /// <param name="result"><c>true</c> if other <see cref="RectangleF"/> intersects with this <see cref="RectangleF"/>; <c>false</c> otherwise. As an output parameter.</param>
