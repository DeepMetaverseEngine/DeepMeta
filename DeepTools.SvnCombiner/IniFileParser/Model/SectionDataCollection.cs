    ...
    public class SectionDataCollection : ICloneable, IEnumerable<SectionData>
    {
        ...
        public void Merge(SectionDataCollection sectionsToMerge)
        {
            foreach(var sectionDataToMerge in sectionsToMerge)
            {
                ...
                var thisSec = this[sectionDataToMerge.SectionName];
                thisSec.Merge(sectionDataToMerge.Keys);
                var sd = this._sectionData[sectionDataToMerge.SectionName];
                sd.LeadingComments.AddRange(sectionDataToMerge.LeadingComments);
                sd.TrailingComments.AddRange(sectionDataToMerge.TrailingComments);
            }
