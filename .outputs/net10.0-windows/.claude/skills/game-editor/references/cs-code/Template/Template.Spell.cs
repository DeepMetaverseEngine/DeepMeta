...
namespace DeepMetaGame.Data.Template
{
    ...
    public class SpellTemplate : TemplateData
    {
        ...
        [Desc(Category = "2.攻击范围", Desc = "尺寸，半径（Round, Fan, Circle）")]
        public float BodySize = 1;
        [Desc(Category = "2.攻击范围", Desc = "弧度（Fan）")]
        [DependOnProperty(nameof(IsShapeFan))]
        public float FanAngle;
        [Desc(Category = "2.攻击范围", Desc = "角度（Fan）")]
        [DependOnProperty(nameof(IsShapeFan))]
        public float FanAngle360
        {
            get => CMath.RadianToAngle(FanAngle);
            set => FanAngle = CMath.AngleToRadian(value);
        }

        [Desc(Category = "2.攻击范围", Desc = "宽度，粗度(Strip, StripRay，StripRayTouchEnd，RectStrip, RectStripRay，Circle, WideStrip)")]
        [DependOnProperty(nameof(IsShapeWide))]
        ...
        [DependOnProperty(nameof(IsShapeDistance))]
