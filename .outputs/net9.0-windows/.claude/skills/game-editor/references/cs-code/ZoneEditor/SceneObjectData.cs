...
namespace DeepMetaGame.Data.ZoneEditor
{
    ...
    public abstract class SceneObjectData : IBaseFuncData
    {
        ...
        public abstract IEnumerable<EditorAbilityData> GetAbilities();
        ...
        public List<T> GetAbilitiesOf<T>() where T : EditorAbilityData
        {
            var ret = new List<T>();
            var abs = GetAbilities();
            if (abs != null)
    ...
    public class UnitData : SceneObjectData
    {
        ...
        public override IEnumerable<EditorAbilityData> GetAbilities() => Abilities;
