...
namespace DeepCrystal.Crypto
{
    public static class RSAHelper
    {
        ...
        public static RSACryptoServiceProvider DecodeX509PublicKey(string pub)
        {
            return DecodeX509PublicKey(Convert.FromBase64String(pub.Replace("-----BEGIN PUBLIC KEY-----", "").Replace("-----END PUBLIC KEY-----", "")));
        }
